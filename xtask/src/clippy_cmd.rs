...
warning: 2 warnings emitted";
    ...
    fn extracts_warnings_errors_and_locations() {
        ...
        assert!(lines[1].contains("--> crates/kozmotic/src/lib.rs:10:9"));
        assert!(lines[2].contains("E0425"));
        assert!(lines[3].contains("--> crates/kozmotic/src/lib.rs:10:5"));
    }
