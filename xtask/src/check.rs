...
error[E0425]: cannot find value `foo` in this scope
 --> crates/kozmotic/src/lib.rs:45:12
error[E0308]: mismatched types
 --> crates/kozmotic/src/main.rs:123:5
...
error: aborting due to 2 previous errors";
    ...
    fn extracts_short_format_path_prefixed_errors() {
        ...
        let stderr = "\
crates/kozmotic/src/lib.rs:45:12: error[E0425]: cannot find value `foo`
crates/kozmotic/src/lib.rs:50:1: error: expected `;`, found `}`
crates/kozmotic/src/lib.rs:9:9: warning: unused variable: `x`
error: aborting due to 2 previous errors";
        let errors = extract_error_lines(stderr);
        assert_eq!(errors.len(), 2);
        assert!(errors[0].contains("E0425"));
